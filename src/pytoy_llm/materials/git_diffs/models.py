...
FilePath = Annotated[Path, Field(description="Relative path"), BeforeValidator(check_relative_path)]
...
class DiffBundle(BaseModel, frozen=True):
    ...
    def model_section_data(self) -> ModelMaterialData:
        ...
        timestamp = time.time()
        description = (
            "JSON-like representation of file diffs for model consumption.\n"
